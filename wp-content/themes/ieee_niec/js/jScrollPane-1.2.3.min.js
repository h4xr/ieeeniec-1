    ...
    A.fn.jScrollPane = function (C) {
        ...
        return this.each(function () {
            ...
            if (A(this).parent().is(".jScrollPaneContainer")) {
                ...
                var M = Ad;
                O.wrap(A("<div></div>").attr({className: "jScrollPaneContainer"}).css({
                    height: Ad + "px",
                    width: d + "px"
                }));
            ...
            if (i < 0.99) {
                ...
                if (C.showArrows) {
                    ...
                    }).css({width: C.scrollbarWidth + "px"}).html("Scroll up").bind("mousedown", function () {
                        g = A(this);
                        Ab = -1;
                        Z();
                        this.blur();
                    ...
                    }).css({width: C.scrollbarWidth + "px"}).html("Scroll down").bind("mousedown", function () {
                        g = A(this);
                        Ab = 1;
                        Z();
                        this.blur();
                ...
                P.css({height: "55px"}).bind("mousedown", E);
                var k;
                var R;
                var I;
                var t = function () {
